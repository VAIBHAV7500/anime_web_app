...
const Review = React.memo(({show_id,setState,getCache, toastConfig}) => {
    ...
    return (
        <div className={styles.reviews}>
            {(loading && !editor) && <div className = {styles.loader}><PulseLoader color="#ffff"/></div>}
            <ToastContainer
            position="top-right"
            autoClose={5000}
            ...
            <div className={styles.editor}>
                <Editor
                    ...
                    toolbar:
                        'undo redo | formatselect | bold italic forecolor backcolor | bullist numlist outdent indent | removeformat'
                    }}
